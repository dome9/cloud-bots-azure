# What it does: Delete any network security group rules that allows RDP access from anywhere (0.0.0.0/0)
...
def run_action(credentials, rule, entity, params):
    ...
    try:
        ...
        for r in (inbound_rules):
            if ('0.0.0.0/0' in r['source'] and '0.0.0.0/0' in r['destination'] and r['destinationPort'] == 3389 and r['destinationPortTo'] == 3389 \
