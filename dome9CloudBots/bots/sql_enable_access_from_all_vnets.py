    ...
    try:  
        ...
        for v in vnets:
            ...
            if sql_server_region == vnet_region:
                ...
                sql_client.virtual_network_rules.begin_create_or_update(server_group_name, sql_server_name, firewall_rule_name, virtual_network_subnet_id=subnet_path, ignore_missing_vnet_service_endpoint=False)
